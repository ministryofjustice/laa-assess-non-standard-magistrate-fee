...
RSpec.describe ApplicationHelper, type: :helper do
  ...
  describe '#govuk_error_summary' do
    ...
    context 'when a form object without errors is given' do
      let(:form_object) { NonStandardMagistratesPayment::MakeDecisionForm.new }
    ...
    context 'when a form object with errors is given' do
      ...
      it 'returns the summary' do
        expect(
          ...
          '<li><a data-turbo="false" href="#non-standard-magistrates-payment-make-decision-form-base-field-error">' \
          'can&#39;t be blank</a></li>' \
          '</ul></div></div></div>'
        )
      end
