...
RSpec.describe ClaimFeedbackMailer, type: :mailer do
  ...
  describe 'granted' do
    context 'with maat id' do
      ...
      let(:personalisation) do
        [laa_case_reference:, ufn:, main_defendant_name:, defendant_id:, claim_total:, date:, feedback_url:]
      end
    ...
    context 'with cntp id' do
      let(:defendant_id) { "Client's CNTP number: CNTP12345" }
      let(:claim) do
  ...
  describe 'part granted' do
    ...
    let(:personalisation) do
      [laa_case_reference:, ufn:, main_defendant_name:,
       defendant_id:, claim_total:, part_grant_total:, caseworker_decision_explanation:,
       date:, feedback_url:]
    end
  ...
  describe 'rejected' do
    ...
    let(:caseworker_decision_explanation) { '' }
    let(:personalisation) do
      [laa_case_reference:, ufn:, main_defendant_name:, defendant_id:, claim_total:,
  ...
  describe 'further information' do
    ...
    let(:personalisation) do
      [laa_case_reference:, ufn:, main_defendant_name:,
       defendant_id:, claim_total:, date_to_respond_by:,
  ...
  describe 'other status' do
    ...
    let(:caseworker_information_requested) { '' }
    let(:personalisation) do
      [laa_case_reference:, ufn:, main_defendant_name:, defendant_id:,
