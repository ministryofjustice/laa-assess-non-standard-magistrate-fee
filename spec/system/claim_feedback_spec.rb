...
Rails.describe 'Claim Feedback', :stub_oauth_token, :stub_update_claim do
  ...
  context 'granted' do
    it 'sends a granted email' do
      visit claim_claim_details_path(claim)
  ...
  context 'part-granted' do
    it 'sends a part granted email' do
      ...
      fill_in 'make-decision-form-partial-comment-field', with: 'Test Data'
  ...
  context 'rejected' do
    it 'sends a rejected email' do
      ...
      click_link_or_button 'Make a decision'
      choose 'Reject it'
      fill_in 'make-decision-form-reject-comment-field', with: 'Test Data'
