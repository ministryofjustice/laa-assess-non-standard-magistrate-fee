...
RSpec.describe NonStandardMagistratesPayment::ClaimsController do
  describe '#index' do
  ...
  describe '#new' do
    context 'when a claim is available to assign' do
      ...
      it 'redirects to the assigned claim' do
        ...
        expect(response).to redirect_to(non_standard_magistrates_payment_claim_claim_details_path(claim))
      end
    end
