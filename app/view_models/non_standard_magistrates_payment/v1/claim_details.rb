  ...
  module V1
    class ClaimDetails < BaseViewModel
      ...
      def data
        [
          {
            title: I18n.t(".non_standard_magistrates_payment.claim_details.#{key}.prosecution_evidence"),
            value:  prosecution_evidence
          },
          {
            title: I18n.t(".non_standard_magistrates_payment.claim_details.#{key}.defence_statement"),
            value:  defence_statement
          },
          {
            title: I18n.t(".non_standard_magistrates_payment.claim_details.#{key}.number_of_witnesses"),
            value:  number_of_witnesses
          },
          {
            title: I18n.t(".non_standard_magistrates_payment.claim_details.#{key}.supplemental_claim"),
            value:  supplemental_claim.capitalize
          },
          {
            title: I18n.t(".non_standard_magistrates_payment.claim_details.#{key}.preparation_time"),
          ...
          {
            title: I18n.t(".non_standard_magistrates_payment.claim_details.#{key}.work_before"),
            value:  work_before.capitalize
          },
          (unless work_before == 'no'
             {
               title: I18n.t(".non_standard_magistrates_payment.claim_details.#{key}.work_before_date"),
               value: format_in_zone(work_before_date)
             }
           end),
          {
            title: I18n.t(".non_standard_magistrates_payment.claim_details.#{key}.work_after"),
            value:  work_after.capitalize
          },
          (unless work_after == 'no'
             {
               title: I18n.t(".non_standard_magistrates_payment.claim_details.#{key}.work_after_date"),
